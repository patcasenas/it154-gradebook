...
if(isset($_POST['importSubmit'])){
    ...
    if(($_FILES['file']['name']) && in_array($_FILES['file']['type'], $csvMimes)){    
        // get file name
        $file = $_FILES['file'];
        ...
        $findSection = explode("_", $fileName);
        $section = $findSection[2];
        ...
        while(($line = fgetcsv($csvFile)) !== FALSE){
            ...
            $db->query("INSERT INTO studentinfo (lastName, firstName, username, studProg, section, courseCode) VALUES ('".$lastName."', '".$firstName."', '".$username."', '".$studProg."', '".$section."', '".$courseCode."')");    
