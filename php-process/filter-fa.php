...
if(isset($_SESSION['filter'])) {
    ...
    $studData = $db->query("SELECT f.formID, f.modNum, f.studNum, f.FA1, f.FA2, f.FA3, f.FA4, f.FA5, f.FA6, f.FA7, f.FA8, f.FA9, f.FA10, f.40per, f.FAavg, si.lastName, si.firstName, si.studProg 
                FROM formative AS f 
