<?php
    ...
    $summative = $db->query("SELECT s.sumID, s.modNum, s.studNum, s.SA1, s.SA2, s.SA3, s.SAavg, s.60per, ta.SAamt, ms.SA1max, ms.SA2max, ms.SA3max 
                            FROM summative AS s
    ...
    $formative = $db->query("SELECT f.formID, f.modNum, f.studNum, f.FA1, f.FA2, f.FA3, f.FA4, f.FA5, f.FA6, f.FA7, f.FA8, f.FA9, f.FA10, f.FAavg, f.40per, ta.FAamt, FA1max, FA2max, FA3max, FA4max, FA5max, FA6max, FA7max, FA8max, FA9max, FA10max 
                            FROM formative AS f 
