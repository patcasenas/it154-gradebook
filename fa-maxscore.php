...
<?php
    if(isset($_POST['maxscore'])) {
        ...
        if($FAamt == 10) {
            ...
            $result = $db->query("UPDATE maxscore SET FA1max = $FA1max, FA2max = $FA2max, FA3max = $FA3max, FA4max = $FA4max, FA5max = $FA5max, FA6max = $FA6max, FA7max = $FA7max, FA8max = $FA8max, FA9max = $FA9max WHERE modID = $modID");
        } else if ($FAamt == 8) {
            $FA1max = $_POST['FA1max'];
            $FA2max = $_POST['FA2max'];
            $FA3max = $_POST['FA3max'];
            ...
            $result = $db->query("UPDATE maxscore SET FA1max = $FA1max, FA2max = $FA2max, FA3max = $FA3max, FA4max = $FA4max, FA5max = $FA5max, FA6max = $FA6max, FA7max = $FA7max, FA8max = $FA8max WHERE modID = $modID");
        } else if ($FAamt == 7) {
            $FA1max = $_POST['FA1max'];
            $FA2max = $_POST['FA2max'];
            $FA3max = $_POST['FA3max'];
            ...
            $result = $db->query("UPDATE maxscore SET FA1max = $FA1max, FA2max = $FA2max, FA3max = $FA3max, FA4max = $FA4max, FA5max = $FA5max, FA6max = $FA6max, FA7max = $FA7max WHERE modID = $modID");
        } else if ($FAamt == 6) {
            $FA1max = $_POST['FA1max'];
            $FA2max = $_POST['FA2max'];
            $FA3max = $_POST['FA3max'];
            ...
            $result = $db->query("UPDATE maxscore SET FA1max = $FA1max, FA2max = $FA2max, FA3max = $FA3max, FA4max = $FA4max, FA5max = $FA5max, FA6max = $FA6max WHERE modID = $modID");
        } else if ($FAamt == 5) {
            $FA1max = $_POST['FA1max'];
            $FA2max = $_POST['FA2max'];
            $FA3max = $_POST['FA3max'];
            ...
            $result = $db->query("UPDATE maxscore SET FA1max = $FA1max, FA2max = $FA2max, FA3max = $FA3max, FA4max = $FA4max WHERE modID = $modID");
        }
        if(!$result) {
            mysqli_error($db);
        } else {
