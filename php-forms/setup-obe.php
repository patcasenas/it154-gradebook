    ...
    <div class="container" id="container">
        ...
        <form action="../php-process/obe-print.php" method="post" target='_blank'>
            <fieldset>
                ...
                <label for="SY">SY:&emsp;20<input type="number" name="SYstart" min="22" value="22">- 20<input
                        type="number" name="SYend" min="23" value="23"></label><br><br>
                <label for="term">Term:&emsp;<input type="number" name="term" min="1" max="4">Q</label><br><br>
                <label for="courseCode">Course Code:&emsp;<input type="text" value=<?php echo $courseCode ?>
                        name="courseCode" readonly></label><br><br>
                ...
                <table style="width: 100%;" class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><textarea name="contribution1" min="1" maxLength="3"
                                    oninput="this.value=this.value.slice(0,this.maxLength)" required></textarea>
                            </td>
                            <td><textarea name="task1" min="1" maxLength="10"
                                    oninput="this.value=this.value.slice(0,this.maxLength)" required></textarea>
                            </td>
                            <td><input type="number" name="satisfactory1" value="70" min="1" maxLength="2"
                                    oninput="this.value=this.value.slice(0,this.maxLength)" required readonly></td>
                            <td><input type="number" name="target1" value="70" min="1" maxLength="2"
                                    oninput="this.value=this.value.slice(0,this.maxLength)" required readonly></td>
                        ...
                        <tr>
                            ...
                            <td><textarea name="contribution2" min="1" maxLength="3"
                                    oninput="this.value=this.value.slice(0,this.maxLength)"></textarea></td>
                            <td><textarea name="task2"></textarea></td>
                            <td><input type="number" name="satisfactory2" value="70" min="1" maxLength="2"
                                    oninput="this.value=this.value.slice(0,this.maxLength)" required readonly></td>
                            <td><input type="number" name="target2" value="70" min="1" maxLength="2"
                                    oninput="this.value=this.value.slice(0,this.maxLength)" required readonly></td>
                        ...
                        <tr>
                            ...
                            <td><textarea name="contribution3" min="1" maxLength="3"
                                    oninput="this.value=this.value.slice(0,this.maxLength)"></textarea></td>
                            <td><textarea name="task3"></textarea></td>
                            <td><input type="number" name="satisfactory3" value="70" min="1" maxLength="2"
                                    oninput="this.value=this.value.slice(0,this.maxLength)" required readonly></td>
                            <td><input type="number" name="target3" value="70" min="1" maxLength="2"
                                    oninput="this.value=this.value.slice(0,this.maxLength)" required readonly></td>
