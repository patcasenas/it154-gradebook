...
<head>
    <?php
        ...
        $modTitle = $db->query ("SELECT modName FROM moduleinfo WHERE modNum = '2' AND courseCode = '".$courseCode."'");
    ?>
...
<body>
    <div class="container" id="container">
        ...
        <div class="btn-section">
            <button onclick="window.location='sa-mod2.php'" id="formative" class="sh rad">Switch to Summative Assessment</button>
